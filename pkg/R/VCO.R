...
#'     will be split over columns \code{OBS.VAL1}, \code{OBS.VAL2}, \eqn{\ldots}. When used in
#'     a validation rule, this must be a literal character. That is, its value can not be
#'     a variable defined earlier in the script.
